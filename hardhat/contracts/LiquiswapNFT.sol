    ...
    AccessControl
{
    ...
    constructor(address _liquiswapContract) ERC721("LiquiswapNFT", "LQS") {
        ...
        _grantRole(
            DEFAULT_ADMIN_ROLE,
            0xa01C18793c1d8b94849DA884FDBcda857af463Ab
        ); // testAccount2
        _grantRole(
            DEFAULT_ADMIN_ROLE,
            0xf9739cF1B992E62a1C5c18C33cacb2a27a91F888
        ); // itachi
    }

    modifier liquiswapOrOwner() {
        require(
            msg.sender == liquiswapContract ||
                hasRole(DEFAULT_ADMIN_ROLE, msg.sender),
            "only liquiswap or admin"
        );
        _;
    }

    // currently, the Liquiswap contract control
    function setLiquiswapContract(
        address _addr
